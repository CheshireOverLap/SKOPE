//! Docking Demo - skope_castling 도킹 시스템 예제
//!
//! 실행: cargo run -p skope_castling --example docking_demo --features app

use skope_castling::prelude::*;
use skope_castling::application::{FloatingWindowRequest, RedockRequest};
use skope_castling::docking::{DragEndNotification, DragOperationRequest, NodeId, DockPosition, TabRole};
use glam::Vec2;
...
impl SlateAppHandler for DockingApp {
    ...
    fn get_external_dock_target(&self) -> Option<skope_castling::docking::NodeRect> {
    ...
    fn get_external_dock_info(&self) -> Option<(NodeId, DockPosition, Option<skope_castling::docking::NodeRect>)> {
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    log::info!("Docking Demo - skope_castling");
    ...
    // 앱 설정
    let config = SlateAppConfig::new("Docking Demo - skope_castling")
        .with_size(1280, 720)
