...
fn vs_main(
    ...
    //   vc_idx(20) | triangle_id(7) | material_id(5)
    // Store visible_cluster index so material_eval can look up instance_id.
    // Note: cluster_idx is still a placeholder (0) — proper prefix-sum lookup is TODO.
    out.triangle_id = ((cluster_idx & 0xFFFFFu) << 12u)
