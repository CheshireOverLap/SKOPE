...
impl UiRenderer {
    pub fn new(
        ...
        Self {
            ...
            screen_size: (width as f32, height as f32),
            text_renderer,
            asset_base_path: "assets/ui".to_string(),
        }
    }
    ...
    pub fn render_with_drag(
        ...
        queue: &wgpu::Queue,
        root: &Widget,
        drag_info: Option<&super::DragRenderInfo>,
    ) {
    ...
    pub fn render_with_overlays(
        ...
        root: &Widget,
        drag_info: Option<&super::DragRenderInfo>,
        tooltip_info: Option<&super::TooltipInfo>,
    ) {
        // 필요한 텍스처 자동 로드
    ...
    fn get_effective_style(&self, widget: &Widget) -> super::style::Style {
