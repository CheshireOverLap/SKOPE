...
const VERTICES: &[Vertex] = &[
    // 앞면 (z = 0.5)
    Vertex { position: [-0.5, -0.5,  0.5], color: [1.0, 0.0, 0.0] }, // 0: 왼쪽 아래 앞
    Vertex { position: [ 0.5, -0.5,  0.5], color: [0.0, 1.0, 0.0] }, // 1: 오른쪽 아래 앞
    Vertex { position: [ 0.5,  0.5,  0.5], color: [0.0, 0.0, 1.0] }, // 2: 오른쪽 위 앞
    Vertex { position: [-0.5,  0.5,  0.5], color: [1.0, 1.0, 0.0] }, // 3: 왼쪽 위 앞

    // 뒷면 (z = -0.5)
    Vertex { position: [-0.5, -0.5, -0.5], color: [1.0, 0.0, 1.0] }, // 4: 왼쪽 아래 뒤
    Vertex { position: [ 0.5, -0.5, -0.5], color: [0.0, 1.0, 1.0] }, // 5: 오른쪽 아래 뒤
    Vertex { position: [ 0.5,  0.5, -0.5], color: [1.0, 1.0, 1.0] }, // 6: 오른쪽 위 뒤
    Vertex { position: [-0.5,  0.5, -0.5], color: [0.5, 0.5, 0.5] }, // 7: 왼쪽 위 뒤
];
